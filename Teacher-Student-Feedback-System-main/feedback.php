...
<div id="table">
  ...
  <div class="tdd">
   <input type="button" onClick="window.location='http://localhost/batch5-main/Teacher-Student-Feedback-System-main/mainhome.html'" value="HOME"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="NEXT" />
        </div>
    <br>
</div>
</form>
